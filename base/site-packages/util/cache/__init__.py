...
func_cache = pylibmc.Client(memcache_settings["func_cache"], binary=True,
                            behaviors={"tcp_nodelay": True, "ketama": True})

page_cache = pylibmc.Client(memcache_settings["page_cache"], binary=True,
                            behaviors={"tcp_nodelay": True, "ketama": True})

fragment_cache = pylibmc.Client(memcache_settings["fragment_cache"], binary=True,
                                behaviors={"tcp_nodelay": True, "ketama": True})

user_cache = pylibmc.Client(memcache_settings["user_cache"], binary=True,
                            behaviors={"tcp_nodelay": True, "ketama": True})
