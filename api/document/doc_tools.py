...
def api_define(name, uri, params=[], result=None, filters=[], description='', add_user=False, api_type=1, wiki='', protocal="http"):
    ...
    def wrap(method):
        ...
        params.append(
        Param('guid', True, str, "1e9c4397fe8eff199b0ff213fffc2293", "1e9c4397fe8eff199b0ff213fffc2293", u'guid'))
        ...
        params.append(Param('ver', False, str, "", "1.0", u'版本'))
        ...
        getattr(method, 'apis').append(
            ApiDefined(name, method.__name__.upper(), uri, params, result, module=method.__module__, filters=filters,
                       description=description, api_type=api_type, wiki=wiki,protocal=protocal))
        return method
