...
cd nginx-1.11.6
./configure --prefix=/mydata/nginx --add-module=/mydata/downloads/ngx_devel_kit-0.2.19   --with-pcre=/mydata/downloads/pcre-8.38  --with-http_stub_status_module --with-http_ssl_module
make
make install
