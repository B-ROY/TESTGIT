function line_basic_b(cate,title,_names,_datas,_value_suffixs,divid,is_right,need_shadow){
...
//饼图函数
function PieChart(_id,_title,_name, names, datas){

    $(function () {
        var _data = [];
        for(var i=0;i<names.length;i++){
            _data.push([names[i], datas[i]]);
        }
        $('#'+_id).highcharts({
            chart: {
